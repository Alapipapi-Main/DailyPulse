 ...
 *
 * - summarizeArticle - A function that handles the news article summarization process.
...
const SummarizeArticleOutputSchema = z.object({
  summary: z
    .string()
    .describe('A concise 1-2 sentence summary of the news article.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a professional news summarizer. Your task is to provide a concise 1-2 sentence summary of a news article.
